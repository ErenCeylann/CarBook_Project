...
namespace CarBook.Api.Controllers
{
    ...
    public class StatisticsController : Controller
    {
        ...
        [HttpGet("GetCarCountByFuelGasolinaOrDisel")]
        public async Task<IActionResult> GetCarCountByFuelGasolinaOrDisel()
        {
            var value = await _mediator.Send(new GetCarCountByFuelGasolinaOrDiselQuery());
            return Ok(value);
        }
